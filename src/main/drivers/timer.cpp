...
timerHardware_t T9=	{TIM2, GPIOA, Pin_5, TIM_Channel_1, TIM2_IRQn, 0, Mode_AF_PP, GPIO_PinSource5, GPIO_AF_1};

timerHardware_t T10= {TIM2, GPIOB, Pin_3, TIM_Channel_2, TIM2_IRQn, 0, Mode_AF_PP, GPIO_PinSource3, GPIO_AF_1}; // PWM8  - PA7  - !TIM3_CH2, *TIM17_CH1, TIM1_CH1N, TIM8_CH1
...
timerHardware_t T12= {TIM3, GPIOB, Pin_1, TIM_Channel_4, TIM3_IRQn, 1, Mode_AF_PP, GPIO_PinSource1, GPIO_AF_2};// PWM  - PA8  - *TIM1_CH1, TIM4_ETR
...
//Virtual Motor 4 Actual Motor M5
timerHardware_t T4= {TIM3, GPIOB, Pin_0, TIM_Channel_3, TIM3_IRQn, 1, Mode_AF_PP, GPIO_PinSource0, GPIO_AF_2}; // PWM1  - PA0  - TIM2_CH1, TIM8

//Virtual Motor 3 Actual Motor M6
timerHardware_t T3= {TIM3, GPIOB, Pin_4, TIM_Channel_1, TIM3_IRQn, 1, Mode_AF_PP, GPIO_PinSource4, GPIO_AF_2}; // PWM2  - PA1  - *TIM2_CH2, TIM15_CH1N

//Virtual Motor 1 Actual Motor M7
timerHardware_t T1= {TIM3, GPIOB, Pin_7, TIM_Channel_4, TIM3_IRQn, 1, Mode_AF_PP, GPIO_PinSource7, GPIO_AF_10}; // PWM3  - PB10 - TIM2_CH3, USART3_TX (AF7)

//Virtual Motor 2 Actual Motor M8
timerHardware_t T2= {TIM3, GPIOA, Pin_7, TIM_Channel_2, TIM3_IRQn, 1, Mode_AF_PP, GPIO_PinSource7, GPIO_AF_2}; // PWM4  - PB11 - *TIM2_CH4, USART3_RX (AF7)
...
void timerConfigure(const timerHardware_t *timerHardwarePtr, uint16_t period,
		uint8_t mhz) {
...
void timerChInit(const timerHardware_t *timHw, channelType_t type,
	int irqPriority) {
...
void timerChConfigCallbacks(const timerHardware_t *timHw,
	timerCCHandlerRec_t *edgeCallback, timerOvrHandlerRec_t *overflowCallback) {
...
void timerChConfigCallbacksDual(const timerHardware_t *timHw,
	timerCCHandlerRec_t *edgeCallbackLo, timerCCHandlerRec_t *edgeCallbackHi,
...
TIM_ICInitStructure.TIM_ICPolarity =
		polarityRising ? TIM_ICPolarity_Rising : TIM_ICPolarity_Falling;
...
TIM_ICInitTypeDef TIM_ICInitStructure;
bool directRising =
		(timHw->channel & TIM_Channel_2) ? !polarityRising : polarityRising;
// configure direct channel
TIM_ICStructInit(&TIM_ICInitStructure);

TIM_ICInitStructure.TIM_Channel = timHw->channel;
TIM_ICInitStructure.TIM_ICPolarity =
		directRising ? TIM_ICPolarity_Rising : TIM_ICPolarity_Falling;
TIM_ICInitStructure.TIM_ICSelection = TIM_ICSelection_DirectTI;
TIM_ICInitStructure.TIM_ICPrescaler = TIM_ICPSC_DIV1;
TIM_ICInitStructure.TIM_ICFilter = getFilter(inputFilterTicks);
TIM_ICInit(timHw->tim, &TIM_ICInitStructure);
...
TIM_ICInitStructure.TIM_ICPolarity =
		directRising ? TIM_ICPolarity_Falling : TIM_ICPolarity_Rising;
...
void timerChConfigOC(const timerHardware_t* timHw, bool outEnable,
	bool stateHigh) {
...
if (outEnable) {
	...
	TIM_OCInitStructure.TIM_OCPolarity =
			stateHigh ? TIM_OCPolarity_High : TIM_OCPolarity_Low;
} else {
