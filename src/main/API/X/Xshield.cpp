...
//
//    delay(10);
//    GPIO.Init(Pin9, Out_PP, SP_2MHz);
//    GPIO.setLow(Pin9);
//
//    delay(10);
//    GPIO.Init(Pin8, Out_PP, SP_2MHz);
//    GPIO.setLow(Pin8);
//
//    delay(30);
//
...
//    delay(30);
//
//    laser_sensors[2]->init(Pin2);
//    delay(30);
//    laser_sensors[2]->setAddress(44);
//
//    delay(30);
//
//
...
//    delay(30);
//
//    laser_sensors[3]->init(Pin16);
//    delay(30);
//    laser_sensors[3]->setAddress(45);
//
//    delay(30);
//
//
...
//}
//
//int16_t Xshield_P::getRange(laser_e range)
//{
//
