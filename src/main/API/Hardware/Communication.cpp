...
uint8_t I2CClass::Read(uint8_t device_add, uint8_t reg, uint8_t length)
{
    uint8_t variable = 0;
    i2cRead(device_add, reg, length, &variable);
    return variable;
}
...
void UARTClass::init(uint32_t baud_rate, UARTportMode_t mode,
        UARTportOptions_t options)
{
